...
class TestAuth(unittest.TestCase):
    ...
    def test_count_with_auth(self, mock_count):
        ...
        resp = self.client.get("/predictions/count", headers={"Authorization": "Basic dGVzdHVzZXI6dGVzdHBhc3M="})
    ...
    def test_count_with_wrong_auth(self, mock_count):
        ...
        resp = self.client.get("/predictions/count", headers={"Authorization": "Basic d3Jvbmc6dXNlcg=="})
        self.assertEqual(resp.status_code, 401)
...
#     def test_count_with_auth(self, mock_count):
#         mock_count.return_value = 7
#         response = self.client.get("/predictions/count", headers=VALID_AUTH_HEADER)
...
#     def test_count_with_wrong_auth(self, mock_count):
#         mock_count.return_value = 0
#         response = self.client.get("/predictions/count", headers=WRONG_AUTH_HEADER)
#         self.assertEqual(response.status_code, 401)
